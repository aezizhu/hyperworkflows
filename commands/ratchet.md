...
3. Dispatch `hyperworkflows-distiller` (background) over the run directory to write candidates under `memory/candidates/`. Remind it: second-occurrence threshold; memory/ only.
